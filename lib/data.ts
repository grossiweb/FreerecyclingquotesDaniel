...
export const LOCATIONS: LocationCountry[] = [
  {
    ...
    metros: [
      ...
      { slug: 'portland-vancouver', name: 'Portland / Vancouver', state: 'OR' },
      ...
      { slug: 'san-diego-carlsbad', name: 'San Diego / Carlsbad', state: 'CA' },
      { slug: 'san-francisco-oakland', name: 'San Francisco / Oakland', state: 'CA' },
  ...
  },
  {
    ...
    metros: [
      ...
      { slug: 'hamilton-burlington', name: 'Hamilton (Burlington)' },
      { slug: 'kitchener-cambridge', name: 'Kitchener (Cambridge, Waterloo)' },
      { slug: 'london-on', name: 'London' },
      { slug: 'montreal-laval', name: 'Montreal (Laval)' },
      { slug: 'ottawa-gatineau', name: 'Ottawa-Gatineau' },
      { slug: 'quebec-city', name: 'Quebec City (Levis)' },
      { slug: 'st-catharines-niagara', name: 'St. Catharines-Niagara' },
      { slug: 'toronto-mississauga', name: 'Toronto (Mississauga)' },
      { slug: 'vancouver-surrey', name: 'Vancouver (Surrey, Burnaby)' },
  ...
  },
  {
    ...
    metros: [
      ...
      { slug: 'brighton-worthing', name: 'Brighton / Worthing / Littlehampton' },
      { slug: 'bristol', name: 'Bristol' },
      { slug: 'cardiff', name: 'Cardiff' },
      { slug: 'coventry-bedworth', name: 'Coventry / Bedworth' },
      { slug: 'edinburgh', name: 'Edinburgh' },
      { slug: 'greater-belfast', name: 'Greater Belfast' },
      { slug: 'greater-glasgow', name: 'Greater Glasgow' },
      { slug: 'greater-london', name: 'Greater London' },
      { slug: 'greater-manchester', name: 'Greater Manchester' },
      { slug: 'kingston-upon-hull', name: 'Kingston upon Hull' },
      { slug: 'leicester', name: 'Leicester' },
      { slug: 'liverpool', name: 'Liverpool' },
      { slug: 'nottingham', name: 'Nottingham' },
      { slug: 'portsmouth', name: 'Portsmouth' },
      { slug: 'reading-wokingham', name: 'Reading / Wokingham' },
      { slug: 'sheffield', name: 'Sheffield' },
      { slug: 'southampton', name: 'Southampton' },
      { slug: 'swansea', name: 'Swansea' },
      { slug: 'teesside', name: 'Teesside' },
      { slug: 'the-potteries', name: 'The Potteries' },
      { slug: 'tyneside', name: 'Tyneside' },
  ...
  },
  {
    ...
    metros: [
      ...
      { slug: 'newcastle-au', name: 'Newcastle' },

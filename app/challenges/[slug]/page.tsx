...
export default function ChallengePage({ params }: { params: { slug: string } }) {
  ...
  return (
    <>
      ...
      {/* ═══ §4 INDUSTRY CONSIDERATIONS — dark split ═══ */}
      <section className="py-24 bg-dark-bg relative overflow-hidden">
      ...
      {/* ═══ §7 FAQ — 15-18 questions, split layout ═══ */}

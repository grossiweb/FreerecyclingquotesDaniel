  ...
  return (
    <>
      ...
      <PageHero
        tag="Simple Process"
        tagIcon="timeline"
        title="How Recycling Quotes"
        titleAccent="Works"
        description="Recycling Quotes simplifies commercial recycling into three steps: request a quote, schedule your pickup, and receive your Certificate of Recycling. The entire process — from initial contact to completed recycling — typically takes 5-10 business days."
        image="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1600&h=600&fit=crop"
        primaryCta={{ label: 'Get Your Free Quote', href: '/get-a-quote', icon: 'arrow_forward' }}
        showPhone
      />
            ...
            {[
              {
                ...
                details: ['Free, no-obligation quotes for all 15+ material types', 'Most quotes delivered within 24 hours — many same day', 'We assess your waste stream and recommend the optimal service', 'Volume-based pricing with no hidden fees'],
              ...
              },
              {
                ...
                details: ['Flexible scheduling: one-time, weekly, or monthly pickups', 'We provide the right containers for your material type and volume', 'GPS-tracked transportation with full chain-of-custody', 'Available in 52+ cities across the US, Canada, UK, and Australia'],
              ...
              },
              {
                ...
                details: ['Certificate of Recycling with weight, material type, and processing details', 'Certificate of Destruction for data-bearing devices (NIST 800-88 compliant)', 'ESG-ready data: carbon offset, water savings, and diversion metrics', 'Rewards program: earn credit toward future pickups'],
              ...
              <ScrollReveal key={step.num} delay={i * 80}>
                <div className="bg-white border border-gray-200 rounded-[24px] p-8 lg:p-10 relative overflow-hidden hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="flex items-start gap-6">
                    <div className="w-16 h-16 flex items-center justify-center bg-dark-bg text-[#4ADE80] text-xl font-extrabold rounded-full shrink-0" style={{ boxShadow: '0 4px 16px rgba(10,15,12,.2)' }}>{step.num}</div>
                    <div className="flex-1">
                      ...
                      <Link href={step.cta.href} className="btn-outline text-[13px]">{step.cta.label} <span className="material-symbols-outlined text-[16px]">arrow_forward</span></Link>
                    </div>
                  </div>
                </div>
              </ScrollReveal>
